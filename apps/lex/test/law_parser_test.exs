defmodule Lex.LawParserTest do
  use ExUnit.Case
  doctest Lex
  alias Lex.LawParser
  alias Lex.LawParser
  ...
  test "extract header and body" do
    ...
    {header, body} = LawParser.extract_header_body(real_content, title)
  ...
  test "extract preliminars, books and transitories" do
    ...
    {preliminars, books, transitories} = LawParser.extract_main_sections(String.strip(body))
